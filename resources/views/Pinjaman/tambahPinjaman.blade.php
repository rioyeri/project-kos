    ...
    <div class="row mt">
      <div class="col-lg-12">
        <div class="form-panel">
          <div class=" form">
            <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="/tambahpinjaman">
              {{ csrf_field() }}
              <div class="form-group ">
                <label for="namaPeminjam" class="control-label col-lg-2">Nama Peminjam</label>
                <div class="col-lg-10">
                  <input class="form-control" name="namaPeminjam" type="text" placeholder='Masukan Nama Peminjam' required/>
                </div>
              </div>
              <div class="form-group ">
                ...
                <label class="control-label col-lg-2">Tanggal Meminjam</label>
                  <div class="col-lg-10">
                    <div data-date-viewmode="years" data-date-format="Y-m-d">
                      <input name="tglPinjam" type="text" size="16" class="form-control default-date-picker" required/>
                    </div>
